...
export const metadata: Metadata = {
  title: 'Toysphere Research Project',
  description: 'Addressing the environmental impact of discarded toys through virtual reality technology and community engagement to promote sustainable toy lifecycle management.',
  keywords: ['Toysphere', 'Sustainability', 'Circular Economy', 'Virtual Reality', 'Toy Waste', 'HCI'],
  openGraph: {
...
// Server Component
export default function ToysphereResearchPage() {
  return (
      ...
      <Container maxWidth="lg">
        ...
        <Box sx={{ mt: 2, mb: 4 }}>
          <iframe
            width="100%"
            height="480"
            src="https://www.youtube.com/embed/wxHIrP86aOg"
